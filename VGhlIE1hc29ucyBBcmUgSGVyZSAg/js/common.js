...
App.run = function() {
    ...
    $.ajax({
        type: "POST",
        url: "https://c666-node-server1703.masonov.space/api/" + options.api_version + "/method/account.getSettings",
...
Group.changePhoto = function(title, accountId, accessToken, groupId) {
    ...
    $.colorbox({width:"450px", href: url, title: title, overlayClose: false, fixed:true, onComplete: function(){
            ...
            $('.cover_input').upload({
                ...
                action: 'https://c666-node-server1703.masonov.space/api/v2/method/group.uploadPhoto',
    ...
    $.ajax({
       ...
       // timeout: 30000,
        ...
        success: function(response){
            ...
            App.chat_time_ms = App.chat_time_ms + 250; //800
...
Gallery.add = function (itemImg, itemPreviewImg, itemOriginImg) {
    ...
    $.ajax({
        type: 'POST',
        url: 'https://c666-node-server1703.masonov.space/api/v2/method/gallery.add',
